...
import { buildAnthropicProviderSettings } from "./anthropicAuth";
  ...
  switch (provider) {
    ...
    case "anthropic": {
      ...
      built = createAnthropic({
        ...buildAnthropicProviderSettings(key),
    ...
    case "claude-code": {
      throw new Error("Claude Code CLI is handled by the chat transport.");
    }
